...
import LogoInvoicely from './Dashboard/LogoInvoicely';

const SideMenuDesktop = ({fetchCurrentUser,currentUser}) => {
  ...
  const renderAccountItem = () =>{
    ...
    return (
        <div className="side-menu-desktop">
            <div ref={innerMenuRef} className="side-menu-desktop__inner-menu" >
             <LogoInvoicely/>
...
export default connect(mapStateToProps,{fetchCurrentUser}) (SideMenuDesktop);
